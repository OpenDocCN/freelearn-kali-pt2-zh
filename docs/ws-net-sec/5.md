...
1.  Since, we expect this to be IRC communication, then using an appropriate display filter can prove handy, And the output is shown here:![Inspection](graphics/B03861_05_21.jpg)
