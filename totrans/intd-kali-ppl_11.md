...
当你准备好访问 TheHive 时，打开另一个浏览器标签页，将网址指向 [http://127.0.0.1:9000](http://127.0.0.1:9000)，你将看到登录界面。幸运的是，TheHive 已经为你创建了一个默认的管理员账户，正如 *图 8.17* 所示。你初次登录时将使用该账户。请输入 **admin** 作为用户名，**secret** 作为密码。然后点击 **Let me in** 按钮正式登录：
